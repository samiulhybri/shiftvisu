...
@Component({
	...
	styleUrl: "./immediate-action.component.css",
})
export class ImmediateActionComponent {
	@ViewChild("immediateActionRef", { static: false }) immediateActionGrid:
		| CustomReactGridTable
		| undefined;
	...
	filterQuery = `eight_d_report_id eq ${this.eightDReportId} and action_type eq '${EightDReportTabType.IMMEDIATE}'`;
	...
	emptyTask = {
		...
		progress: 0,
		description: "",
		action_type: EightDReportTabType.IMMEDIATE,
	};
	...
	ngOnChanges(changes: SimpleChanges): void {
		if (
			...
			this.data = [];
			this.filterQuery = `eight_d_report_id eq ${this.eightDReportId} and action_type eq '${EightDReportTabType.IMMEDIATE}'`;
		}
	}
