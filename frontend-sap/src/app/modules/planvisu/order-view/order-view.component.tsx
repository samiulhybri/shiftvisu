...
export class OrderViewComponent {
	...
	columns = [
		...
		},
		{
			...
			accessor: "prodOrderPos.due_date",
				...
				return (
					<React.StrictMode>
						<FlexBox alignItems="End">
							<Text>
								{rowData.prodOrderPos.due_date
									? moment(rowData.prodOrderPos.due_date).format("DD.MM.YYYY")
									: null}
							</Text>
						</FlexBox>
					</React.StrictMode>
  ...
  actionButtons = [
	...
	openOrderReSchedule = (data: any) => {
		this.selectedOrderId = data.prodOrderPos.prodOrder.id;
	}
