...
class CostCenterImport extends Command
{
    use DispatchesJobs;
     ...
     * @var string
     */
    protected $signature = 'import:costcenter';
    ...
    public function handle(): int
    {
        ...
        foreach ($costCenters as $costCenter) {
            ...
            FieldChecker::setField('is_active', $record, $costCenter, $record->is_active);
            ...
            FieldChecker::setField('cost', $recordCost, $costCenter, $recordCost->cost);
            FieldChecker::setField('cost_type', $recordCost, $costCenter, $recordCost->cost_type);
