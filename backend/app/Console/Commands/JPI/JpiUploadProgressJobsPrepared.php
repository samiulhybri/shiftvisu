...
class JpiUploadProgressJobsPrepared extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'jpi:upload_progress_jobs_prepared';
    ...
    public function handle()
    {
        ...
        $controller->cloudUploadJobsWithPreparedProgress();
