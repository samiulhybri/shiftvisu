...
class ProdInspectionOperationResourceDto
{
    ...
    public static function fromStdClass(stdClass $obj): ProdInspectionOperationResourceDto
    {
        return new ProdInspectionOperationResourceDto(
            $obj->is_active ?? true,
            $obj->pos ?? null,
            $obj->equipment_id_custom ?? null,
            ProdInspectionOperationResourceType::tryFrom($obj->type) ?? ProdInspectionOperationResourceType::EQUIPMENT,
