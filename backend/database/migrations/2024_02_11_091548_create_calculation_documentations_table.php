...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('calculation_documentations', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(Calculation::class)->constrained()->cascadeOnDelete();
            $table->foreignIdFor(Documentation::class)->constrained()->cascadeOnDelete();
            ...
            $table->timestamps();
            $table->unique(['calculation_id','documentation_id'],'calculation_documentations_unique_index');
        });
    }
    ...
    {
        Schema::dropIfExists('calculation_documentations');
    }
};
