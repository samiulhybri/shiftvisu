...
return new class extends Migration {
    ...
    {
        Schema::create('user_registered_times', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignIdFor(StandardValueKeyActivityType::class)
                ->nullable()->constrained(indexName: 'user_registered_times_svk_activity_type_id_foreign');
    ...
    {
        Schema::dropIfExists('user_registered_times');
    }
};
