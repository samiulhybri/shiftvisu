...
return new class extends Migration
{
    ...
    {
        Schema::create('inspection_operation_characteristics', function (Blueprint $table) {
            $table->id();
            $table->morphs('characteristicable', indexName: 'characteristicable_index');
            $table->string('pos');
            ...
            $table->foreignIdFor(AttributeSet::class)->nullable()->constrained()->nullOnDelete();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('inspection_operation_characteristics');
    }
};
